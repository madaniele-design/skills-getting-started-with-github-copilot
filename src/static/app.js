document.addEventListener("DOMContentLoaded", () => {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        activityCard.innerHTML = `
          ...
          <div class="participants-list">
            ${details.participants.map(email => `<div class="participant-item">${email} <a href="#" class="delete-link" data-activity="${name}" data-email="${email}">delete</a></div>`).join('')}
          </div>
        `;
  ...
  // Handle delete participant links
